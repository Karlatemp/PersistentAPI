 ...
 * @create 2020/06/07 10:42:37
 *
 * PersistentApi/PersistentApi.main/PersistentDataContainer.java
 */
...
public interface PersistentDataContainer {
    ...
    /**
     * Stores a metadata value on the {@link org.bukkit.persistence.PersistentDataHolder} instance.
     * <p>
     ...
     * value the {@link org.bukkit.persistence.PersistentDataHolder} may have stored under the provided
     * key.
     *
     ...
     * the {@link org.bukkit.persistence.PersistentDataType#getPrimitiveType()}
     */
     ...
     * <p>
     * Storing a value using a custom {@link org.bukkit.persistence.PersistentDataType} implementation
     * will not store the complex data type. Therefore storing a UUID (by
     * storing a byte[]) will match has("key" ,
     * {@link org.bukkit.persistence.PersistentDataType#BYTE_ARRAY}). Likewise a stored byte[] will
     * always match your UUID {@link org.bukkit.persistence.PersistentDataType} even if it is not 16
     * bytes long.
     * <p>
     ...
     * {@link org.bukkit.persistence.PersistentDataHolder} instance.
     *
     ...
     * @throws IllegalArgumentException if no suitable adapter will be found for
     * the {@link
     * org.bukkit.persistence.PersistentDataType#getPrimitiveType()}
     */
    @Nullable
    ...
    /**
     * Returns the metadata value that is stored on the
     * {@link org.bukkit.persistence.PersistentDataHolder} instance. If the value does not exist in the
    ...
    /**
     * Removes a custom key from the {@link org.bukkit.persistence.PersistentDataHolder} instance.
     *
     * @param key the key
     *
