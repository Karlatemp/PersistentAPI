...
package io.github.karlatemp.persistentapi.nms.v1_9_R1;
...
public class Registry implements BiFunction<PersistentDataTypeRegistry, Class, TagAdapter>, Supplier {
    ...
    public TagAdapter apply(PersistentDataTypeRegistry registry, Class type) {
        ...
        if (Objects.equals(Byte.class, type)) {
            return PersistentDataTypeRegistry.createAdapter(Byte.class, NBTTagByte.class, NBTTagByte::new, NBTTagByte::f);
        } else if (Objects.equals(Short.class, type)) {
            return PersistentDataTypeRegistry.createAdapter(Short.class, NBTTagShort.class, NBTTagShort::new, NBTTagShort::e);
        } else if (Objects.equals(Integer.class, type)) {
            return PersistentDataTypeRegistry.createAdapter(Integer.class, NBTTagInt.class, NBTTagInt::new, NBTTagInt::d);
        } else if (Objects.equals(Long.class, type)) {
            return PersistentDataTypeRegistry.createAdapter(Long.class, NBTTagLong.class, NBTTagLong::new, NBTTagLong::c);
        } else if (Objects.equals(Float.class, type)) {
            return PersistentDataTypeRegistry.createAdapter(Float.class, NBTTagFloat.class, NBTTagFloat::new, NBTTagFloat::h);
        } else if (Objects.equals(Double.class, type)) {
            return PersistentDataTypeRegistry.createAdapter(Double.class, NBTTagDouble.class, NBTTagDouble::new, NBTTagDouble::g);
        } else if (Objects.equals(String.class, type)) {
            return PersistentDataTypeRegistry.createAdapter(String.class, NBTTagString.class, NBTTagString::new, NBTTagString::a_);
